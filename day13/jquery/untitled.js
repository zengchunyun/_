/* jdf-1.0.0/ base.js Date:2016-01-13 15:05:50 */
if (!
function(a, b) {
	function c(a) {
		return function(b) {
	...
	function f(a) {
		for (var b = [], c = a.__KEYS, d = 0, e = c.length; e > d; d++) {
			var g = c[d],
				h = f(a[g]),
				i = h.length;
			if (i) for (var j = 0; i > j; j++) b.push(g + "/" + h[j]);
			else b.push(g)
		}
		return b
	}
...
}(), window.pageConfig = window.pageConfig || {}, "undefined" == typeof pageConfig.autoConfig && (pageConfig.autoConfig = !0), "undefined" == typeof pageConfig.preload && (pageConfig.preload = !0), pageConfig.jdfVersion || (pageConfig.jdfVersion = "1.0.0"), pageConfig.jdfBaseUri || (pageConfig.jdfBaseUri = ("https:" == document.location.protocol ? "//" : "http://") + "misc.360buyimg.com/"), pageConfig.autoConfig) {
...
if (pageConfig.wideVersion = function() {
	return /isdebug=.*\-2(\D|$)/.test(location.search) ? !1 : screen.width >= 1210 && pageConfig.compatible
}(), pageConfig.wideVersion && (document.getElementsByTagName("html")[0].className = "root61"), pageConfig.FN_getDomain = function() {
	var a = location.hostname;
	var b = "jd.com";
	return /jd.com/.test(a) ? b = "jd.com" : /jd360.hk/.test(a) ? b = "jd360.hk" : /jd.hk/.test(a) ? b = "jd.hk" : /360buy.com/.test(a) && (b = "360buy.com"), b
...
}, /isdebug=.*\-1(\D|$)/.test(location.search) && !
function() {
	function a() {
...
function(a, b) {
	...
	f.fn.extend({
		...
		"toggleClass": function(a, b) {
			...
			function(c) {
				...
				if ("string" === c) for (var e, g = 0, h = f(this), i = b, j = a.split(o); e = j[g++];) i = d ? i : !h.hasClass(e), h[i ? "addClass" : "removeClass"](e);
	...
	f.support.focusinBubbles || f.each({
		...
		f.fn[c] = function(a, d, e) {
			...
			else for (var i = 0, j = this.length; j > i; i++) f.event.add(this[i], a, g, d);
			return this
		}
	}), f.fn.extend({
		"unbind": function(a, b) {
			if ("object" != typeof a || a.preventDefault) for (var d = 0, e = this.length; e > d; d++) f.event.remove(this[d], a, b);
	...
	f.each(["live", "die"], function(a, c) {
		...
		var k = function(b, d, f, g) {
				...
				else for (j = l.relative[x[0]] ? [d] : k(x.shift(), d); x.length;) b = x.shift(), l.relative[b] && (b += x.shift()), j = v(b, j);
...
}(window); /* product-global/1.0.1 basePath.js Date:2016-01-07 10:42:43 */
pageConfig.FN_GetRandomData = function(a) {
	var d, b = 0,
		c = 0,
		e = [];
	...
	var g, d = b[0].data,
		e = [],
		f = 3 == d.length ? "style2" : "style1";
	e.push('<div class="slide-itemswrap"><ul class="slide-items"><li class="'), e.push(f), e.push('" data-tag="'), e.push(b[0].aid), e.push('">');
	for (var h = 0; h < d.length; h++) g = this.FN_GetCompatibleData(d[h]), e.push('<div class="fore'), e.push(h + 1), e.push('" width="'), e.push(g.width), e.push('" height="'), e.push(g.height), e.push('"><a target="_blank" href="'), e.push(g.href), e.push('" title="'), e.push(g.alt), e.push('"><img src="'), 0 == h ? e.push(g.src) : (e.push('//misc.360buyimg.com/lib/img/e/blank.gif" style="background:url('), e.push(g.src), e.push(") no-repeat center 0;")), e.push('" width="'), e.push(g.width), e.push('" height="'), e.push(g.height), e.push('" /></a></div>');
	e.push('</li></ul></div><div class="slide-controls"><span class="curr">1</span></div>'), document.getElementById(a).innerHTML = e.join("")
	...
	a.fn.Jtab = function(b, c) {
		if (this.length) {
			...
			var e = a(this).find("*[" + d.hookKey + "=" + d.hookItemVal + "]"),
	...
	a.fn.jdTab = function(b, c) {
		...
		var e = a(this).find(d.tab).eq(0).find(d.itemTag),
	...
	a.fn.Jlazyload = function(b, c) {
		if (this.length) {
			var f, g, d = a.extend({
				...
				placeholderImage: "//misc.360buyimg.com/lib/img/e/blank.gif",
				...
				h = function(a) {
					var b = a.scrollLeft,
						...
						d = a.offsetWidth,
						e = a.offsetHeight;
					for (; a.offsetParent;) b += a.offsetLeft, c += a.offsetTop, a = a.offsetParent;
					return {
						left: b,
						top: c,
						width: d,
				...
				j = function(a, b) {
					var c, e, f, g, h, i, j = d.threshold ? parseInt(d.threshold) : 0;
					return c = a.left + a.width / 2, e = b.left + b.width / 2, f = a.top + a.height / 2, g = b.top + b.height / 2, h = (a.width + b.width) / 2, i = (a.height + b.height) / 2, Math.abs(c - e) < h + j && Math.abs(f - g) < i + j
				},
				k = function(a, b, e) {
					d.placeholderImage && d.placeholderClass && e.attr("src", d.placeholderImage).addClass(d.placeholderClass), a && (e.attr("src", b).removeAttr(d.source), c && c(b, e))
				},
				l = function(b, e, f) {
					if (b) {
						var g = a("#" + e);
						g.html(f.val()).removeAttr(d.source), f.remove(), c && c(e, f)
					}
				},
				m = function(a, b, e) {
					a && (e.removeAttr(d.source), c && c(b, e))
				},
				n = function() {
					g = i(), e = e.filter(function() {
						return a(this).attr(d.source)
					}), a.each(e, function() {
						var b = a(this).attr(d.source);
						if (b) {
							var c = d.offsetParent ? h(a(d.offsetParent).get(0)) : g,
								e = h(this),
								f = j(c, e);
							switch (d.type) {
							case "image":
				...
				o = function() {
					e.length > 0 && (clearTimeout(f), f = setTimeout(function() {
						n()
					}, 10))
				};
			n(), d.offsetParent ? a(d.offsetParent).bind("scroll", function() {
				o()
...
function() {
	...
	a.fn.jdSlide = function(b) {
		...
		var k = c.pics.length;
		var l = function() {
				var b = "<ul style='position:absolute;top:0;left:0;'><li><a href='" + c.pics[0].href + "' target='_blank'><img src='" + c.pics[0].src + "' width='" + c.width + "' height='" + c.height + "' /></a></li></ul>";
				d.css({
					position: "relative"
				}).html(b), a(function() {
					p()
		...
		var m = function() {
				...
				var f;
				for (var h = 0; k > h; h++) {
					switch (b = h == c.index ? c.current : "", c.type) {
					case "num":
						f = h + 1;
						break;
					case "string":
						...
						break;
					case "image":
						f = "<img src='" + c.pics[h].breviary + "' />"
					}
					a.push("<span class='"), a.push(b), a.push("'><a href='"), a.push(c.pics[h].href), a.push("' target='_blank'>"), a.push(f), a.push("</a></span>")
				}
				a.push("</div>"), d.append(a.join("")), d.find("span").bind("mouseover", function() {
					j = !1, clearTimeout(e), clearTimeout(g);
					var a = d.find("span").index(this);
					c.index != a && (g = setInterval(function() {
						i && n(a)
					}, c.delay1))
				}).bind("mouseleave", function() {
					j = !0, clearTimeout(e), clearTimeout(g), e = setTimeout(function() {
						n(c.index + 1, !0)
					}, c.delay2)
				})
			};
		var n = function(a, b) {
				a == k && (a = 0), f = setTimeout(function() {
					d.find("span").eq(c.index).removeClass(c.current), d.find("span").eq(a).addClass(c.current), o(a, b)
				}, 20)
			};
		var o = function(a, b) {
				var g = parseInt(h);
				var l = Math.abs(g + c.index * c.height);
				var m = Math.abs(a - c.index) * c.height;
				var p = Math.ceil((m - l) / 4);
				l == m ? (clearTimeout(f), b ? (c.index++, c.index == k && (c.index = 0)) : c.index = a, i = !0, i && j && (clearTimeout(e), e = setTimeout(function() {
					n(c.index + 1, !0)
				}, c.delay2))) : (c.index < a ? (h = g - p, d.find("ul").css({
					top: h + "px"
				})) : (h = g + p, d.find("ul").css({
					top: h + "px"
				})), i = !1, f = setTimeout(function() {
					o(a, b)
				}, 20))
			};
		var p = function() {
				var a = [];
				for (var b = 1; k > b; b++) a.push("<li><a href='"), a.push(c.pics[b].href), a.push("' target='_blank'><img src='"), a.push(c.pics[b].src), a.push("' width='"), a.push(c.width), a.push("' height='"), a.push(c.height), a.push("' /></a></li>");
				d.find("ul").append(a.join("")), e = setTimeout(function() {
					n(c.index + 1, !0)
				}, c.delay2), c.type && m()
			}
	}
	...
	a.fn.jdMarquee = function(b, c) {
		...
		var e = this.find(d.dom[1]);
		var f = this.find(d.dom[2]);
		var g;
		if ("up" == d.deriction || "down" == d.deriction) {
			var h = e.eq(0).outerHeight();
			var i = d.step * f.eq(0).outerHeight();
			e.css({
				width: d.width + "px",
				overflow: "hidden"
			})
		}
		if ("left" == d.deriction || "right" == d.deriction) {
			var j = f.length * f.eq(0).outerWidth();
			e.css({
				width: j + "px",
				overflow: "hidden"
			});
			var i = d.step * f.eq(0).outerWidth()
		}
		var k = function() {
				var a = "<div style='position:relative;overflow:hidden;z-index:1;width:" + d.width + "px;height:" + d.height + "px;" + d.wrapstyle + "'></div>";
				switch (e.css({
					position: "absolute",
					left: 0,
					top: 0
				}).wrap(a), d.pos.object = 0, g = e.clone(), e.after(g), d.deriction) {
				default:
				case "up":
					e.css({
						marginLeft: 0,
		...
		var l = function(a) {
				n(d.mainTimer), d.stay = a ? a : d.stay, d.mainTimer = setInterval(function() {
					m()
				}, d.stay)
			};
		var m = function() {
				n(d.subTimer), d.subTimer = setInterval(function() {
					s()
				}, d.delay)
			};
		var n = function(a) {
		...
		var o = function(b) {
				b ? (a(d._front).unbind("click"), a(d._back).unbind("click"), a(d._stop).unbind("click"), a(d._continue).unbind("click")) : p()
			};
		var p = function() {
				null != d._front && a(d._front).click(function() {
					a(d._front).addClass(d.disabled), o(!0), n(d.mainTimer), d.convert = !0, d.btn = "front", m(), d.auto || (d.tag = !0), q()
				}), null != d._back && a(d._back).click(function() {
					a(d._back).addClass(d.disabled), o(!0), n(d.mainTimer), d.convert = !0, d.btn = "back", m(), d.auto || (d.tag = !0), q()
				}), null != d._stop && a(d._stop).click(function() {
					n(d.mainTimer)
				}), null != d._continue && a(d._continue).click(function() {
					l()
				})
			};
		var q = function() {
				d.tag && d.convert && (d.convert = !1, "front" == d.btn && ("down" == d.deriction && (d.deriction = "up"), "right" == d.deriction && (d.deriction = "left")), "back" == d.btn && ("up" == d.deriction && (d.deriction = "down"), "left" == d.deriction && (d.deriction = "right")), d.auto ? l() : l(4 * d.delay))
			};
		var r = function(a, b, c) {
				c ? (n(d.subTimer), d.pos.object = a, d.pos.clone = b, d.tag = !0) : d.tag = !1, d.tag && (d.convert ? q() : d.auto || n(d.mainTimer)), ("up" == d.deriction || "down" == d.deriction) && (e.css({
					marginTop: a + "px"
				}), g.css({
					marginTop: b + "px"
				})), ("left" == d.deriction || "right" == d.deriction) && (e.css({
					marginLeft: a + "px"
				}), g.css({
					marginLeft: b + "px"
				}))
		...
		var s = function() {
				var b = parseInt("up" == d.deriction || "down" == d.deriction ? e.get(0).style.marginTop : e.get(0).style.marginLeft);
				var c = parseInt("up" == d.deriction || "down" == d.deriction ? g.get(0).style.marginTop : g.get(0).style.marginLeft);
				var f = Math.max(Math.abs(b - d.pos.object), Math.abs(c - d.pos.clone));
				var k = Math.ceil((i - f) / d.speed);
				switch (d.deriction) {
				case "up":
					f == i ? (r(b, c, !0), a(d._front).removeClass(d.disabled), o(!1)) : (-h >= b && (b = c + h, d.pos.object = b), -h >= c && (c = b + h, d.pos.clone = c), r(b - k, c - k));
					break;
				case "down":
					f == i ? (r(b, c, !0), a(d._back).removeClass(d.disabled), o(!1)) : (b >= h && (b = c - h, d.pos.object = b), c >= h && (c = b - h, d.pos.clone = c), r(b + k, c + k));
					break;
				case "left":
					f == i ? (r(b, c, !0), a(d._front).removeClass(d.disabled), o(!1)) : (-j >= b && (b = c + j, d.pos.object = b), -j >= c && (c = b + j, d.pos.clone = c), r(b - k, c - k));
					break;
				case "right":
					f == i ? (r(b, c, !0), a(d._back).removeClass(d.disabled), o(!1)) : (b >= j && (b = c - j, d.pos.object = b), c >= j && (c = b - j, d.pos.clone = c), r(b + k, c + k))
				}
			};
		("up" == d.deriction || "down" == d.deriction) && h >= d.height && h >= d.step && k(), ("left" == d.deriction || "right" == d.deriction) && j >= d.width && j >= d.step && k()
	}
}(jQuery);